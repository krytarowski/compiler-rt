...
unsigned struct_tone_sz = sizeof(struct tone);
unsigned union_twe_statrequest_sz = sizeof(union_twe_statrequest);
unsigned struct_usb_device_descriptor_sz = sizeof(struct usb_device_descriptor);
...
unsigned struct__agp_region_sz = sizeof(struct _agp_region);
...
unsigned enum_dmx_source_sz = sizeof(enum_dmx_source);
unsigned union_dvd_authinfo_sz = sizeof(union_dvd_authinfo);
unsigned union_dvd_struct_sz = sizeof(union_dvd_struct sz);
unsigned enum_v4l2_priority_sz = sizeof(enum_v4l2_priority);
...
unsigned enum_fe_sec_mini_cmd_sz = sizeof(enum_fe_sec_mini_cmd);
unsigned enum_fe_sec_tone_mode_sz = sizeof(enum_fe_sec_tone_mode);
unsigned enum_fe_sec_voltage_sz = sizeof(enum_fe_sec_voltage);
unsigned enum_fe_status_sz = sizeof(enum_fe_status);
...
unsigned struct_iscsi_conn_status_parameters_sz = sizeof(struct iscsi_conn_status_parameters);
unsigned struct_iscsi_get_version_parameters_sz = sizeof(struct iscsi_get_version_parameters);
unsigned struct_iscsi_iocommand_parameters_sz = sizeof(struct iscsi_iocommand_parameters);
unsigned struct_iscsi_login_parameters_sz = sizeof(struct iscsi_login_parameters);
unsigned struct_iscsi_logout_parameters_sz = sizeof(struct iscsi_logout_parameters);
unsigned struct_iscsi_register_event_parameters_sz = sizeof(struct iscsi_register_event_parameters);
unsigned struct_iscsi_remove_parameters_sz = sizeof(struct iscsi_remove_parameters);
unsigned struct_iscsi_send_targets_parameters_sz = sizeof(struct iscsi_send_targets_parameters);
unsigned struct_iscsi_set_node_name_parameters_sz = sizeof(struct iscsi_set_node_name_parameters);
unsigned struct_iscsi_wait_event_parameters_sz = sizeof(struct iscsi_wait_event_parameters);
unsigned struct_isp_stats_sz = sizeof(struct isp_stats);
...
unsigned struct_mpu_command_rec_sz = sizeof(struct mpu_command_rec);
unsigned struct_rndstat_sz = sizeof(struct rndstat);
unsigned struct_rndstat_name_sz = sizeof(struct rndstat_name);
unsigned struct_rndctl_sz = sizeof(struct rndctl);
unsigned struct_rnddata_sz = sizeof(struct rnddata);
unsigned struct_rndpoolstat_sz = sizeof(struct rndpoolstat);
unsigned struct_rndstat_est_sz = sizeof(struct rndstat_est);
unsigned struct_rndstat_est_name_sz = sizeof(struct rndstat_est_name);
unsigned struct_pps_params_sz = sizeof(struct pps_params);
unsigned struct_pps_info_sz = sizeof(struct pps_info);
unsigned struct_mixer_info_sz = sizeof(struct mixer_info);
unsigned struct_RF_SparetWait_sz = sizeof(struct RF_SparetWait);
unsigned struct_RF_ComponentLabel_sz = sizeof(struct RF_ComponentLabel);
unsigned struct_RF_SingleComponent_sz = sizeof(struct RF_SingleComponent);
