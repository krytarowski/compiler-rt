...
unsigned struct_fbinfo_sz = sizeof(fbinfo);
...
unsigned struct_hd44780_info_sz = sizeof(hd44780_info);
unsigned struct_hd44780_io_sz = sizeof(hd44780_io);
...
unsigned struct_ioc_read_subchannel _sz = sizeof(ioc_read_subchannel );
unsigned struct_ioc_read_subchannel_buf_sz = sizeof(ioc_read_subchannel_buf);
unsigned struct_ioc_read_toc_entry_buf_sz = sizeof(ioc_read_toc_entry_buf);
...
unsigned struct_lua_create_sz = sizeof(lua_create);
unsigned struct_lua_info_sz = sizeof(lua_info);
unsigned struct_lua_load_sz = sizeof(lua_load);
...
unsigned struct_midi_info_sz = sizeof(midi_info);
...
unsigned struct_mmc_discinfo_sz = sizeof(mmc_discinfo);
unsigned struct_mmc_op_sz = sizeof(mmc_op);
unsigned struct_mmc_trackinfo_sz = sizeof(mmc_trackinfo);
unsigned struct_mmc_writeparams_sz = sizeof(mmc_writeparams);
...
unsigned struct_obioc_disk_sz = sizeof(obioc_disk);
unsigned struct_obioc_vol_sz = sizeof(obioc_vol);
...
unsigned struct_olddisklabel_sz = sizeof(olddisklabel);
...
unsigned struct_partinfo_sz = sizeof(partinfo);
...
unsigned struct_remove_sample_sz = sizeof(remove_sample);
...
unsigned struct_rf_test_acc_sz = sizeof(rf_test_acc);
...
unsigned struct_synth_control_sz = sizeof(synth_control);
...
unsigned struct_timeval50_sz = sizeof(timeval50);
...
#if 0
unsigned IOCTL_ALTQATTACH = ALTQATTACH;
unsigned IOCTL_ALTQDETACH = ALTQDETACH;
unsigned IOCTL_ALTQENABLE = ALTQENABLE;
unsigned IOCTL_ALTQDISABLE = ALTQDISABLE;
unsigned IOCTL_ALTQCLEAR = ALTQCLEAR;
unsigned IOCTL_ALTQCONFIG = ALTQCONFIG;
unsigned IOCTL_ALTQADDCLASS = ALTQADDCLASS;
unsigned IOCTL_ALTQMODCLASS = ALTQMODCLASS;
unsigned IOCTL_ALTQDELCLASS = ALTQDELCLASS;
unsigned IOCTL_ALTQADDFILTER = ALTQADDFILTER;
unsigned IOCTL_ALTQDELFILTER = ALTQDELFILTER;
unsigned IOCTL_ALTQGETSTATS = ALTQGETSTATS;
unsigned IOCTL_ALTQGETCNTR = ALTQGETCNTR;
#endif
...
#if 0
unsigned IOCTL_HLCD_DISPCTL = HLCD_DISPCTL;
unsigned IOCTL_HLCD_RESET = HLCD_RESET;
unsigned IOCTL_HLCD_CLEAR = HLCD_CLEAR;
unsigned IOCTL_HLCD_CURSOR_LEFT = HLCD_CURSOR_LEFT;
unsigned IOCTL_HLCD_CURSOR_RIGHT = HLCD_CURSOR_RIGHT;
unsigned IOCTL_HLCD_GET_CURSOR_POS = HLCD_GET_CURSOR_POS;
unsigned IOCTL_HLCD_SET_CURSOR_POS = HLCD_SET_CURSOR_POS;
unsigned IOCTL_HLCD_GETC = HLCD_GETC;
unsigned IOCTL_HLCD_PUTC = HLCD_PUTC;
unsigned IOCTL_HLCD_SHIFT_LEFT = HLCD_SHIFT_LEFT;
unsigned IOCTL_HLCD_SHIFT_RIGHT = HLCD_SHIFT_RIGHT;
unsigned IOCTL_HLCD_HOME = HLCD_HOME;
unsigned IOCTL_HLCD_WRITE = HLCD_WRITE;
unsigned IOCTL_HLCD_READ = HLCD_READ;
unsigned IOCTL_HLCD_REDRAW = HLCD_REDRAW;
unsigned IOCTL_HLCD_WRITE_INST = HLCD_WRITE_INST;
unsigned IOCTL_HLCD_WRITE_DATA = HLCD_WRITE_DATA;
unsigned IOCTL_HLCD_GET_INFO = HLCD_GET_INFO;
unsigned IOCTL_HLCD_GET_CHIPNO = HLCD_GET_CHIPNO;
unsigned IOCTL_HLCD_SET_CHIPNO = HLCD_SET_CHIPNO;
#endif
...
#if 0
unsigned IOCTL_RAIDFRAME_TEST_ACC = RAIDFRAME_TEST_ACC;
#endif
...
#if 0
unsigned IOCTL_OBIOCDISK = OBIOCDISK;
#endif
unsigned IOCTL_BIOCVOL = BIOCVOL;
#if 0
unsigned IOCTL_OBIOCVOL = OBIOCVOL;
#endif
...
#if 0
unsigned IOCTL_BIOCSORTIMEOUT = BIOCSORTIMEOUT;
unsigned IOCTL_BIOCGORTIMEOUT = BIOCGORTIMEOUT;
#endif
...
#if 0
unsigned IOCTL_PPPIOCSPASS = PPPIOCSPASS;
unsigned IOCTL_PPPIOCSACTIVE = PPPIOCSACTIVE;
unsigned IOCTL_PPPIOCSIPASS = PPPIOCSIPASS;
unsigned IOCTL_PPPIOCSOPASS = PPPIOCSOPASS;
unsigned IOCTL_PPPIOCSIACTIVE = PPPIOCSIACTIVE;
unsigned IOCTL_PPPIOCSOACTIVE = PPPIOCSOACTIVE;
#endif
...
#if 0
unsigned IOCTL_SIOCPROXY = SIOCPROXY;
#endif
...
#if 0
unsigned IOCTL_SIOCXRAWATM = SIOCXRAWATM;
#endif
...
#if 0
unsigned IOCTL_AGPIOC_RESERVE = AGPIOC_RESERVE;
unsigned IOCTL_AGPIOC_PROTECT = AGPIOC_PROTECT;
#endif
...
#if 0
unsigned IOCTL_CDIOCREADSUBCHANNEL_BUF = CDIOCREADSUBCHANNEL_BUF;
#endif
unsigned IOCTL_CDIOREADTOCHEADER = CDIOREADTOCHEADER;
unsigned IOCTL_CDIOREADTOCENTRIES = CDIOREADTOCENTRIES;
#if 0
unsigned IOCTL_CDIOREADTOCENTRIES_BUF = CDIOREADTOCENTRIES_BUF;
#endif
...
#if 0
unsigned IOCTL_MMCGETDISCINFO = MMCGETDISCINFO;
unsigned IOCTL_MMCGETTRACKINFO = MMCGETTRACKINFO;
unsigned IOCTL_MMCOP = MMCOP;
unsigned IOCTL_MMCSETUPWRITEPARAMS = MMCSETUPWRITEPARAMS;
#endif
...
#if 0
unsigned IOCTL_DIOCGPARTINFO = DIOCGPARTINFO;
unsigned IOCTL_ODIOCGDINFO = ODIOCGDINFO;
unsigned IOCTL_ODIOCSDINFO = ODIOCSDINFO;
unsigned IOCTL_ODIOCWDINFO = ODIOCWDINFO;
#endif
...
#if 0
unsigned IOCTL_ODIOCGDEFLABEL = ODIOCGDEFLABEL;
#endif
...
#if 0
unsigned IOCTL_GPIOPINREAD = GPIOPINREAD;
unsigned IOCTL_GPIOPINWRITE = GPIOPINWRITE;
unsigned IOCTL_GPIOPINTOGGLE = GPIOPINTOGGLE;
unsigned IOCTL_GPIOPINCTL = GPIOPINCTL;
unsigned IOCTL_GPIODETACH = GPIODETACH;
#endif
...
#if 0
unsigned IOCTL_SEQUENCER_PERCMODE = SEQUENCER_PERCMODE;
unsigned IOCTL_SEQUENCER_TESTMIDI = SEQUENCER_TESTMIDI;
#endif
...
#if 0
unsigned IOCTL_SEQUENCER_MIDI_INFO = SEQUENCER_MIDI_INFO;
#endif
...
#if 0
unsigned IOCTL_SEQUENCER_ID = SEQUENCER_ID;
unsigned IOCTL_SEQUENCER_CONTROL = SEQUENCER_CONTROL;
unsigned IOCTL_SEQUENCER_REMOVESAMPLE = SEQUENCER_REMOVESAMPLE;
#endif
...
#if 0
unsigned IOCTL_EVTCHN_RESET = EVTCHN_RESET;
unsigned IOCTL_EVTCHN_BIND = EVTCHN_BIND;
unsigned IOCTL_EVTCHN_UNBIND = EVTCHN_UNBIND;
#endif
