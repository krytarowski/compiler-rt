...
int code, 			    ... register_t args[SYS_MAXSYSARGS]
int rval
void
...
const char *path
int fd
const char *path, mode_t mode, uint32_t dev
const char *path, mode_t mode
...
const char *path, struct stat43 *ub
void
const char *path, 			    struct stat43 *ub
int fd
void
...
mode_t newmask
const char *path
int fd, struct stat43 *sb
int op, char *where, int *size, 			    int arg
void
...
void
const char *name
int which, 			    struct itimerval50 *itv
...
int s, void *name, 			    socklen_t *anamelen
int which, id_t who
...
int s, void *msg, int flags
struct timeval50 *tp, 			    void *tzp
int who, struct rusage50 *rusage
...
const char *path, mode_t mode
const char *path
const char *path, 			    const struct timeval50 *tptr
const struct timeval50 *delta, 			    struct timeval50 *olddelta
int fdes, void *asa, 			    socklen_t *alen
void
int32_t hostid
int which, 			    struct orlimit *rlp
int which, 			    const struct orlimit *rlp
int pgid, int signum
void
const char *path, int cmd, 			    int uid, void *arg
void
int fdec, void *asa, 			    socklen_t *alen
int flag, void *argp
int fd, char *buf, 			    u_int count, long *basep
const char *path, 			    struct statfs12 *buf
int fd, struct statfs12 *buf
...
struct ntptimeval30 *ntvp
struct timex *tp
gid_t gid
gid_t egid
uid_t euid
fsid_t *fsidp, 			    struct block_info *blkiov, int blkcnt
fsid_t *fsidp, 			    struct block_info *blkiov, int blkcnt
fsid_t *fsidp, u_long segment
fsid_t *fsidp, 			    struct timeval50 *tv
const char *path, struct stat12 *ub
int fd, struct stat12 *sb
const char *path, 			    struct stat12 *ub
...
quad_t code, 			    ... register_t args[SYS_MAXSYSARGS]
int fd, int PAD, off_t offset, 			    int whence
const char *path, int PAD, 			    off_t length
int fd, int PAD, off_t length
const int *name, u_int namelen, 			    void *oldv, size_t *oldlenp, const void *newv, 			    size_t newlen
const void *addr, size_t len
const void *addr, size_t len
const char *path
int fd, 			    const struct timeval50 *tptr
pid_t pid
...
int flag
int msqid, int cmd, 			    struct msqid_ds14 *buf
...
int shmid, int cmd, 			    struct shmid_ds14 *buf
const void *shmaddr
key_t key, size_t size,				    int shmflg
clockid_t clock_id, 			    struct timespec50 *tp
clockid_t clock_id, 			    const struct timespec50 *tp
clockid_t clock_id, 			    struct timespec50 *tp
clockid_t clock_id, 			    struct sigevent *evp, timer_t *timerid
timer_t timerid
timer_t timerid, 			    int flags, const struct itimerspec50 *value, 			    struct itimerspec50 *ovalue
timer_t timerid, 			    struct itimerspec50 *value
timer_t timerid
const struct timespec50 *rqtp, 			    struct timespec50 *rmtp
int fd
int flags
void
const sigset_t *set, 			    siginfo_t *info, struct timespec50 *timeout
pid_t pid, 			    const siginfo_t *info
int cmd, void *arg
unsigned int value, intptr_t *idp
const char *name, int oflag, 			    mode_t mode, unsigned int value, intptr_t *idp
const char *name
intptr_t id
intptr_t id
intptr_t id
intptr_t id
intptr_t id, 			    unsigned int *value
intptr_t id
intptr_t id, 				const struct timespec *abstime
...
mqd_t mqdes, 			    const char *msg_ptr, size_t msg_len, 			    unsigned msg_prio, 			    const struct timespec50 *abs_timeout
mqd_t mqdes, 			    char *msg_ptr, size_t msg_len, unsigned *msg_prio, 			    const struct timespec50 *abs_timeout
const char *from, 			    const char *to
...
const char *path, struct stat13 *ub
int fd, struct stat13 *sb
const char *path, struct stat13 *ub
...
int fd
const struct compat_30_fhandle *fhp, int flags
const struct compat_30_fhandle *fhp, 			    struct stat13 *sb
const struct compat_30_fhandle *fhp, 			    struct statfs12 *buf
int semid, int semnum, int cmd, 			    ... union __semun *arg
int msqid, int cmd, 			    struct msqid_ds *buf
int shmid, int cmd, 			    struct shmid_ds13 *buf
const char *path, u_long flags
void
...
lwpid_t target
const struct timespec50 *ts, 				lwpid_t unpark, const void *hint, 				const void *unparkhint
...
void *newv, void **oldv, 				int flags, ssize_t stackinfo_offset
int num, stack_t *stacks
void
int concurrency
void
int sa_id
...
void
int fd, 			    const struct kevent *changelist, size_t nchanges, 			    struct kevent *eventlist, size_t nevents, 			    const struct timespec50 *timeout
...
const struct compat_30_fhandle *fhp, 			    struct statvfs *buf, int flags
...
const char *path, 			    int attrnamespace, void *data, size_t nbytes
int nd, fd_set *in, fd_set *ou, 			    fd_set *ex, const struct timespec50 *ts, 			    const sigset_t *mask
struct pollfd *fds, u_int nfds, 			    const struct timespec50 *ts, const sigset_t *mask
...
const char *path, struct stat30 *ub
int fd, struct stat30 *sb
const char *path, struct stat30 *ub
int fd, char *buf, size_t count
const struct compat_30_fhandle 			    *fhp, struct stat30 *sb
struct ntptimeval50 *ntvp
int domain, int type, int protocol
const char *fname, void *fhp, 			    size_t *fh_size
const void *fhp, size_t fh_size,			    int flags
const void *fhp, 			    size_t fh_size, struct statvfs *buf, int flags
const void *fhp, 			    size_t fh_size, struct stat30 *sb
int fildes, struct aiocb *aiocbp
const struct aiocb *aiocbp
int op, struct aiocb *aiocbp
struct aiocb *aiocbp
struct aiocb *aiocbp
const struct aiocb *const *list, 		    int nent, const struct timespec50 *timeout
struct aiocb *aiocbp
...
fsid_t *fsidp, 			    struct timeval *tv
...
struct pollfd *fds, u_int nfds, 			    const struct timespec *ts, const sigset_t *mask
 			    const struct aiocb *const *list, 			    int nent, const struct timespec *timeout
...
int fd, const char *path, 			    mode_t mode, int PAD, dev_t dev
int fd, const char *path, 			    mode_t mode
...
clockid_t clock_id, int flags, 			    struct timespec *ts, lwpid_t unpark, 			    const void *hint, const void *unparkhint
int fd, int PAD, off_t pos, 			    off_t len
int fd, int PAD, off_t pos, 			    off_t len
idtype_t idtype, id_t id, 			    int *status, int options, struct wrusage *wru, 			    siginfo_t *info
